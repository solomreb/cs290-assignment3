...
Instructions
------------
X- Create a new repository called cs290-assignment3 at the location you specified in week 1.
X- Clone this repository and copy all of the contents to that repository
...
X- Add **OSU-CS290-Tester** as a collaborator. This will be an account that myself and the TAs share to access your repos.
